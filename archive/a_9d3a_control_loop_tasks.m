...
%    s_code = 'C:\Data\OneDrive - Michigan State University\Current Work\1 test scripts\2019Mar script testing\Fo_scripts_9';    % local
   s_code = 'C:\data\OneDrive - Michigan State University\Current Work\1 Matlab analysis\Fo_scripts_9d3';  
...
%    end
   ...
   if u_figson==1||u_figson==3
      ...
      [tmpy,tmpx]=hist([concat1.f0_fo_prtfi concat1.f0_fo_audi concat1.f0_fo_shpi],rngtmp);
