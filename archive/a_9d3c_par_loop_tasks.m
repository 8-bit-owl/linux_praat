...
u_ftitle = 'HBV_vowlmic'; %'% name to put in documents, no spaces';
...
if s_dir == 0
   ...
   s_code = 'C:\Data2Analyze\1 Matlab analysis\Fo_scripts_9d3';    % local
...
parfor g_iter = s_start:g_cnt          %loop through all files in the directory
   ...
   [outdata,sigaS,t1S,sig_dB,t2,t2Si,dB_vals,f0_So_aud,f0_fo_shp,f0_fo_prtf,f0_fo_aud,...
      g_duration]=...
      a_9d3c_par_task_function(g_iter,g_cnt,g_filename,g_titlename,...
