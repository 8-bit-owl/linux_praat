...
u_ftitle = 'PTS_vowlmic_ser'; %'% name to put in documents, no spaces';
...
u_trimYN = 4;         % 0 to analyze the files as they are
...
%       spec1dB=LTAS.norm0spectrum;
   ...
   if u_figson==1||u_figson==3
      ...
      title(['\alpha_{ratio}=' num2str(round(LTAS.AlphaRatio)) ...
         ...
         'dB ; {\SigmadB_{n(2.8-3.4k)}}=' num2str(round(100*LTAS.dBsingersformN)/100)],'Fontsize',8)       
