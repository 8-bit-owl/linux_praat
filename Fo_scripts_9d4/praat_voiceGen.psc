...
To Pitch (analysistype)... 0 fo_lower 15 no 0.03 VoiceThresh 0.01 0.35 0.14 fo_upper
select Sound 'name$'
...
plus Pitch 'name$'
plus Sound 'name$'
voiceReport$ = Voice report... 0 0 fo_lower fo_upper 1.3 1.6 0.03 VoiceThresh
