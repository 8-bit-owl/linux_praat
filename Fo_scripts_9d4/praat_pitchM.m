function [t, F0] = praat_pitchM(data, varargin)
...
audiowrite('praat.wav',data, varargin{1});
	if isunix == 1; commstring = './praat_barren praat_pitchM.psc praat.wav';
	elseif ispc == 1; commstring = 'praatcon praat_pitchM.psc praat.wav';
	end
    %	  commstring = 'praatcon praat_pitchM.psc praat.wav';
    %     commstring = 'praatcon_win98 praat_pitchM.psc praat.wav';
...
elseif (nargin == 1)
    if (isa(data,'char'))
        commstring = ['praatcon praat_pitchM.psc ' data];
%         commstring = ['praatcon_win98 praat_pitchM.psc ' data];
    else
