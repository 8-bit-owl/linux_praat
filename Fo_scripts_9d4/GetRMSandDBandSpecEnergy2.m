function [sig_RMS,sig_dB,sig_fftE,t2,gain_volt,frame_sz]=GetRMSandDBandSpecEnergy2(...
   siga,frm_sz_ms,frm_step_ms,Fs,gain_volt)
...
%     t2-         the time array for both of the above in seconds
...
t1=(1:length(siga))/Fs;
t2 = frm_step_ms*(1:length(sig_RMS))/(1000);
