...
% Log_ratio_threshold2, Autocorrelation_Threshold_Level] = formant_tracker_backend(X, Fs,
% lpc_window_size, window, Filter_Cutoff_init, Log_ratio_threshold1_init, Log_ratio_threshold2_init,
% Autocorrelation_Threshold_Level_init, RMS_Ratio_F1, RMS_Ratio_F2, RMS_Ratio_F3, RMS_Ratio_F4);  
%
%  This function returns the first four formant frequencies of the signal, X. It performs all the
%  calculations outlined in the technical references to estimate the formants.
%  
%
% INPUTS
...
if (1) 
    ...
    F0to4_init = [150; 458; 1435; 2705; 3819];
