function measures = voice_measures2(x, fs, varargin)
...
%     % added by Mark Berardi May 2016
%     oct3 = LTAS.oct3lev;
%     p3 = polyfit((1:length(oct3))/3,oct3,1);
%     LTAS.tilt = p3(1);
    ...
    if nargin < 3
        perturb = praat_voice2(x, Fs);
    else
        perturb = praat_voice2(x, Fs, varargin{1});
    end
