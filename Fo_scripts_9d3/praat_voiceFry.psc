...
To Pitch (ac)... 0 76 15 no 0.03 0.45 0.01 0.35 0.14 250
To Pitch (analysistype)... 0 75 15 no 0.03 0.25 0.01 0.35 0.14 230
select Sound 'name$'
To PointProcess (periodic, cc)... 76 250

select PointProcess 'name$'
plus Pitch 'name$'
plus Sound 'name$'
voiceReport$ = Voice report... 0 0 76 250 1.3 1.6 0.03 0.45
